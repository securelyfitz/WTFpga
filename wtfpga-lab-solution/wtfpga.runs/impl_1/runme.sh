...
HD_PWD='/home/swift/wtfpga-solution/wtfpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WTFpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WTFpga.tcl -notrace
